...
{{WARNING}} `getinfo` will be removed in a later version of Lifetioncoin
...
- n: "→<br>`version`"
  t: "number (int)"
  p: "Required<br>(exactly 1)"
  d: "This node's version of Bitcoin Core in its internal integer format.  For example, Lifetioncoin Core 0.12.2 has the integer version number 120200"
...
- n: "→<br>`privatesend_balance`"
  t: "number (duffs)"
  p: "Optional<br>(0 or 1)"
  d: "The PrivateSend balance of the wallet in duffs.  Only returned if wallet support is enabled  (Added in Lifetioncoin Core 0.11.0)"
...
*Example from Lifetioncoin Core 0.12.2 with wallet support enabled*
