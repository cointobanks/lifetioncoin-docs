...
- n: "→<br>`difficulty`"
  t: "number (real)"
  p: "Required<br>(exactly 1)"
  d: "The difficulty of the highest-height block in the best block chain (Added in Lifetioncoin Core 0.12.1)"

- n: "→<br>`chainwork`"
  t: "string (hex)"
  p: "Required<br>(exactly 1)"
  d: "The estimated number of block header hashes checked from the genesis block to this block, encoded as big-endian hex (Added in Lifetioncoin Core 0.12.1)"
...
- n: "→ →<br>`forkpoint`"
  t: "string (hex)"
  p: "Required<br>(exactly 1)"
  d: "*Added in Lifetioncoin Core 0.12.3*<br><br>Block hash of the last common block between this tip and the main chain"
