...
- n: "`payoutAddress`"
  t: "string"
  p: "Required<br>(exactly 1)"
  d: "The Lifetioncoin address to use for masternode reward payments."
{% enditemplate %}
...
- n: "`collateralAddress`"
  t: "string (hex)"
  p: "Required<br>(exactly 1)"
  d: "The Lifetioncoin address to send the collateral to"
{% enditemplate %}
...
- n: "`operatorPayoutAddress`"
  t: "string (hex)"
  p: "Optional<br>(0 or 1)"
  d: "The Lifetioncoin address used for operator reward payments. Only allowed when the ProRegTx had a non-zero `operatorReward` value. If set to an empty string, the currently active payout address is reused."
{% enditemplate %}
...
- n: "`payoutAddress`"
  t: "string (hex)"
  p: "Optional<br>(0 or 1)"
  d: "The Lifetioncoin address to use for masternode reward payments. If set to an empty string, the last on-chain payout address of the masternode will be used."
{% enditemplate %}
...
- n: "→<br>`merkleRootQuorums`"
  t: "string (hex)"
  p: "Required<br>(exactly 1)"
  d: "*Added in Coinbase Transaction version 2 (Lifetioncoin Core 0.14.0)*<br><br>Merkle root of the masternode list"
{% enditemplate %}
