...
- n: "`data-hex`"
  t: "string (hex)"
  p: "Required<br>(exactly 1)"
  d: "**Updated in Lifetioncoin Core 0.14.0 to require all new proposals to use JSON serialization.**<br><br>Object data (JSON object with governance details). Additional details regarding this are provided in an example below."
...
- n: "`use-IS`"
  ...
  d: "*Added in Lifetioncoin Core 0.13.0*<br><br>InstantSend lock the collateral, only requiring one chain confirmation"
...
- n: "`outputHash`"
  t: "string (hex)"
  p: "Optional<br>(0 or 1)"
  d: "*Added in Lifetioncoin Core 0.13.0*<br><br>The single output to submit the proposal fee from"
...
- n: "`outputIndex`"
  t: "numeric"
  p: "Optional<br>(0 or 1)"
  d: "*Added in Lifetioncoin Core 0.13.0*<br><br>The output index (required if the `outputHash` parameter is provided)"
...
- n: "`data-hex`"
  t: "string (hex)"
  p: "Required<br>(exactly 1)"
  d: "**Updated in Lifetioncoin Core 0.14.0 to require all new proposals to use JSON serialization.**<br><br>Object data (JSON object with governance details). See [GObject Prepare](#gobject-prepare) for additional details about this field."
...
- n: "`mode`"
  ...
  d: "Result return format:<br>`json` (default)<br>`all` - Default before Lifetioncoin Core 0.12.3 (for backwards compatibility)"
...
*Example from Lifetioncoin Core 0.14.0 (mode: `json`/default)*
...
*Example from Lifetioncoin Core 0.14.0 (mode: `all`)*
