...
- n: "→<br>`address`"
  ...
  d: "The Lifetioncoin address given as parameter"
...
- n: "→<br>`timestamp`"
  t: "number (int)"
  p: "Optional<br>(0 or 1)"
  d: "*Added in Lifetioncoin Core 0.12.3*<br><br>The creation time of the key if available in seconds since epoch (Jan 1 1970 GMT)"
