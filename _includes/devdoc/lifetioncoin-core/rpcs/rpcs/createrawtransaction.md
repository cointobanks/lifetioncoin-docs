...
- n: "→ →<br>`Sequence`"
  ...
  d: "Added in Lifetioncoin Core 0.12.3.0.<br><br>The sequence number to use for the input"
...
- n: "→<br>Address/Amount"
  t: "string : number (Lifetioncoin)"
  p: "Required<br>(1 or more)"
  d: "A key/value pair with the address to pay as a string (key) and the amount to pay that address (value) in Lifetioncoin"
