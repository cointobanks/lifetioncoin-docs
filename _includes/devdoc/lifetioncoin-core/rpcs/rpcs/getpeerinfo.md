...
- n: "→ →<br>`banscore`"
  t: "number (int)"
  p: "Required<br>(exactly 1)"
  d: "The ban score we've assigned the node based on any misbehavior it's made.  By default, Lifetioncoin Core disconnects when the ban score reaches `100`"
...
[
  {
    ...
    "minping": 0.187152,
    "version": 70208,
    "subver": "/Lifetioncoin Core:0.12.2/",
    "inbound": false,
    "startingheight": 8416,
    "banscore": 0,
    "synced_headers": 8474,
