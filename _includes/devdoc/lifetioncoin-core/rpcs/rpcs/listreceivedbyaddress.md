...
- n: "→ →<br>`account`"
  t: "string"
  p: "Required<br>(exactly 1)"
  d: "*Deprecated: will be removed in a later version of Lifetioncoin Core*<br><br>The account the address belongs to.  May be the default account, an empty string (\"\")"
